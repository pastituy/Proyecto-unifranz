              ...
              >
                <CardHeader>
                  ...
                  <EstadoBadge $estado={beneficiario.estadoBeneficiario}>
                    {beneficiario.estadoBeneficiario === 'ACTIVO' ? 'ACTIVO' : 'INACTIVO'}
                  </EstadoBadge>
                </CardHeader>
...
const BeneficiarioCard = styled.div`
  ...
  border-radius: 12px;
  padding: 20px;
  border: 2px solid ${props => props.$selected ? '#ff6347' : '#e0e0e0'};
  cursor: pointer;
...
const EstadoBadge = styled.div`
  ...
  background: ${props => props.$estado === 'ACTIVO' ? '#fff3e0' : '#f8d7da'};
  color: ${props => props.$estado === 'ACTIVO' ? '#e65100' : '#721c24'};
`;
